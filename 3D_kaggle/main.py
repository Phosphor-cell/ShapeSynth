...
#----   File Paths  ----
CSV_PATH  = "3D_kaggle/labels.csv"
JSON_PATH = "3D_kaggle/labels.json"
DATA_DIR = "D:\Machine_Learning\Data"
version = "v3"
...
mesh_loader = DataLoader(mesh_data, batch_size = BATCH_SIZE, shuffle=False , num_workers=0,collate_fn=collate_fn, pin_memory = True)
...
if __name__ == "__main__":
    ...
    for epochs in range(EPOCHS):
        ...
        for j, batch in enumerate(mesh_loader):
            if batch is None:
                continue
        ...
        #with autocast(dtype=torch.float16):
            ...
            for i, task_name in enumerate(TASK_NAMES):
                ...
                loss = loss / ACCUMULATION_LOSS
                total_loss += loss
        
            total_loss.backward()
        
            if (j + 1) % ACCUMULATION_LOSS == 0:
                optimizer.step()
                optimizer.zero_grad()
    ...
    torch.save(model.state_dict(), f'/kaggle/working/ML_3D_{version}.pth')
